...
gmsh.model.add("mesh_platebeam_elec")
...
gmsh.model.geo.extrude([(2, 5)], 0.0, T,0.0 , [nt-1], [1],true )
...
output_file = joinpath(dirname(@__FILE__), "mesh_platebeam_elec.msh")
