...
gmsh.model.add("mecmodel")

# parameters
const L=6;      # beam length
const W=1;       # beam width
const T=0.5;     # beam thickness

const nl=12; # X element size
...
# gmsh.model.addPhysicalGroup(1, [17,28,6,7,8,19,5], 5, "neuma")  
...
gmsh.model.addPhysicalGroup(2, [2,33], 5, "neuma")  
gmsh.model.addPhysicalGroup(3, [1,2], 1, "Volume")  
 

output_file = joinpath(dirname(@__FILE__), "mecmodel.msh")
