...
writedlm("Trajectory_027_00_015_0162.csv", hcat(Coord1_y_predicted_sorted_point_descaled.+First_Point_MatCoords[1],zeros(64).+First_Point_MatCoords[2],Coord3_y_predicted_sorted_point_descaled.+First_Point_MatCoords[3]),",")
