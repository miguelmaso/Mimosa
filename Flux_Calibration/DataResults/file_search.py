...
def main():
    ...
    filenames_output_file = 'filenames_output_FE_Trajectory.txt'  # Output file for filenames without extensions
    contents_output_file = 'contents_output_FE_Trajectory.txt'  # Output file for contents array
