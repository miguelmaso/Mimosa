...
conf = CSV.File("data/csv/Config_N800_EM_PB_10S.csv") |> Tables.Columns
...
df = DataFrame(z, :auto)
CSV.write("data/csv/EM_PB_10S_12.csv", df)
t1 = time()
Δt = t1-t0
println("------- Total Elapsed time: $Δt s")

jldsave("data/uh_EM_PB_10S_12.jld2";uh_)